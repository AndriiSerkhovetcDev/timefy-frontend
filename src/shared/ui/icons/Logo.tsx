...
export const Logo = ({ isSidebarCollapsed = false }: LogoProps) => {
  ...
  return (
    <>
      <div className="w-10 h-10 bg-linear-to-br from-primary to-secondary rounded-xl flex items-center justify-center text-primary-foreground shadow-lg">
      ...
      <span
        className={cn(
          ...
          isSchemas ? "text-sidebar-shell-foreground" : "text-primary",
        )}
        style={{
