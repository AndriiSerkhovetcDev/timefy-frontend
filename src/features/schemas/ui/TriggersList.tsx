  ...
  return (
    <div className="px-8 py-6">
      <div className="flex items-center justify-between mb-6">
        <h2 className="text-base font-medium text-text-main">Trigger: {trigger.name}</h2>
      </div>
      ...
      <section className="mb-8">
        ...
        <div className="grid grid-cols-2 gap-4">
          <div className="flex flex-col gap-1.5">
            <label className="text-xs text-text-muted">Table</label>
            <input
              type="text"
              defaultValue={trigger.table ?? ""}
              className="text-xs font-mono border border-border rounded-lg px-3 py-1.5 focus:outline-none focus:border-teal-400"
            />
          </div>
