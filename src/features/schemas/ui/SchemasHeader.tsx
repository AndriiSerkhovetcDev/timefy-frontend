      ...
      <div className="mx-auto px-4 sm:px-6 lg:px-8">
        <div className="flex justify-between items-center h-14">
          <div className="flex items-center">
            {isSidebarCollapsed ? (
              <PanelLeftOpen
                className="w-5 h-5 text-gray-500 cursor-pointer hover:text-primary transition"
            ...
            <h1 className="pl-5 text-xl font-semibold text-gray-900">{activeSchema}</h1>
          </div>
          <div className="flex items-center gap-5">
            ...
            <Settings className="w-5 h-5 text-gray-500 cursor-pointer hover:text-primary transition" />
