...
Старий flow «Змінити пароль через email» прибрано зі сторінки безпеки. Публічний flow «Забули пароль?» на сторінці входу залишається доступним як recovery-механізм.
